...
// 13. Escriu una consulta per trobar els restaurants que no preparen cap cuisine de 'American' i van obtenir un punt de grau 'A' i no pertanyen a Brooklyn. S'ha de mostrar el document segons la cuisine en ordre descendent: 
...
db.restaurant.find({borough: {$eq: "Bronx"}, cuisine: {$in: ["American ", "Chinese"]}})
...
db.restaurant.find({$or: [{cuisine: {$nin: ["American ", "Chinese"]}}, {name: {$eq: /^Wil/}}]}, {_id: 0, restaurant_id: 1, name: 1, borough: 1, cuisine: 1})
...
db.restaurant.find({"grades.score": {$mod: [7, 0]}}, {_id: 0, restaurant_id: 1, name: 1, "grades.grade": 1})
